...
@dataclass          #with this decorator we are directly able to defice our class variables
class DataIngestionConfig:          #all inputs processed through here
...
class DataIngestion:
    ...
    def initiate_data_ingestion(self):
        logging.info("entered thedata ingestion method or component")
        try:
